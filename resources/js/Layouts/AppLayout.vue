      ...
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-auto d-flex flex-row align-items-center">
          <div class="user-settings gap-2 gap-sm-3 pe-3">
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="wallet align-items-center">
                    ...
                    <div class="d-grid">
                      <h6
                        class="fw-bold crypt-grayscale-100 mb-0 d-flex justify-content-between"
                      >
                        {{ account.slice(0, 5) + "***" + account.slice(-6) }}
                        <button @click="copyAddress" style="background: none;border: none;"
                      ...
                      <a class="d-flex gap-2 mb-2 verified mt-2">
                        <p class="crypt-grayscale-600 mb-0">MON:</p>
            ...
            <button
              class="navbar-toggler d-md-none ms-4"
              type="button"
              @click="toggleMenu"
            >
              <svg
